...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       body.Quantity();
        ...
        body.setLocationByPlatform(true);
        body.setSize(575,600);
...
class Body extends JFrame
{
    ...
    private JLabel logo_name, delivery_type, date_time, table_no, name, address, contact, flavors_label,toppings_label, quantity_label;
    private ImageIcon logo;
    private JTextField table_no_tf, name_tf, address_tf, contact_tf;
    private JPanel input_panel, delivery_panel, toppings_panel, toppings2_panel,flavors1_panel, quantity_panel, initial_panel, buttons_panel;
    private JPanel top1_panel, flv1_panel, top2_panel;
    private JCheckBox top_onion, top_mushroom, top_broccoli, top_corn, top_capsicum, top_cheese,flv_HamAndCheese,flv_Hawaiian ,flv_Pepperoni;
   ...
   public void Quantity()
    ...
    public void Flavor() {
        flv1_panel = new JPanel();
        flv1_panel.setLayout(new GridLayout(1, 3));

        flavors1_panel = new JPanel();
        flavors1_panel.setLayout(new GridLayout(2, 1));


        flavors_label = new JLabel("Flavors:");

        flv_Hawaiian = new JCheckBox("Hawaiian", false);
        flv_HamAndCheese = new JCheckBox("Ham And Cheese", false);
        flv_Pepperoni = new JCheckBox("Pepperoni", false);
        ...
        flv_Hawaiian.addItemListener(itemListener);
        flv_HamAndCheese.addItemListener(itemListener);
        flv_Pepperoni.addItemListener(itemListener);


        flv1_panel.add(flv_Hawaiian);
        flv1_panel.add(flv_HamAndCheese);
        flv1_panel.add(flv_Pepperoni );

        flavors1_panel.add( flavors_label);
        flavors1_panel.add(flv1_panel);
    ...
    public void Output()
    {
        ...
        print.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                ...
                JOptionPane.showMessageDialog(null, "This is the price for single Pizza !");
            }
        });
